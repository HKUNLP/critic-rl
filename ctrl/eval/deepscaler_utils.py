"""Adapted from https://github.com/agentica-project/deepscaler/tree/main"""
...
class RewardMathFn(RewardFn):
    ...
    def __call__(self, input: RewardInput) -> RewardOutput:
        ...
        # Extract solution.
        # NOTE: We directly use the extracted solution.
        ...
        if not processed_ground_truths:
            raise ValueError("No valid ground truth answers found.")
            return RewardOutput(reward=self.config.unk_error_reward, is_correct=False)
